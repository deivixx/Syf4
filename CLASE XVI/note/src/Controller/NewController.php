...
class NewController extends AbstractController {
    ...
    public function testFileAttached() {
        ...
        $disposition = HeaderUtils::makeDisposition(
                        HeaderUtils::DISPOSITION_ATTACHMENT, 'hola.txt'
        );
    ...
    /**
     * @Route("/tagtest", name="new_tagtest")
     */
    public function tagTest() {

        $cursos = array(0 => 'Symfony 4', 1 => 'Seguridad Web', 2 => 'DevOps');

        return $this->render('new/tag.test.html.twig', ['cursos' => $cursos]);
    }

    
    
    /**
     * @Route("/filtertest", name="new_filtertest")
     */
    public function filterTest() {

        $cursos = array(0 => 'symfony 4', 1 => 'seguridad Web', 2 => 'devOps');

        return $this->render('new/filter.test.html.twig', ['cursos' => $cursos]);
    }    
	
	

    /**
     * @Route("/linktest", name="new_linktest")
     */
    public function linkTest() {

        return $this->render('new/link.test.html.twig');
    }


    /**
     * @Route("/apptest", name="new_apptest")
     */
    public function appTest(SessionInterface $session) {

        if (is_null($session->get('name'))) {
            $session->set('name', 'david');
        }
        
        return $this->render('new/app.test.html.twig');
    } 
